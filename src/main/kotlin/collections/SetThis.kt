...
fun main() {
    ...
    val myDrinks = setOf("Water", "Coffee", "Tea")
    val myPartnersDrinks = setOf("Water", "Beer", "Wine")
    println("My drinks: $myDrinks")
    println("My partner's drinks: $myPartnersDrinks")
    println("Our drinks: ${myDrinks.union(myPartnersDrinks)}")
    println("Our common drinks: ${myDrinks.intersect(myPartnersDrinks)}")
    println("Our unique drinks: ${myDrinks.subtract(myPartnersDrinks)}")
    val acceptedColors = hashSetOf("Black", "White", "Green", "Blue")
    val myColors = hashSetOf("Black", "Red", "Yellow")
    println("Accepted colors: $acceptedColors")
    println("My colors: $myColors")
    println("Colors that I can wear: ${acceptedColors.intersect(myColors)}")
    println("My company now accepts red)")
    acceptedColors.add("Red")
    println("Colors that I can wear after the change: ${acceptedColors.intersect(myColors)}")
}